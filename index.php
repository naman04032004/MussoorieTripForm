...
<body>
    ...
    <div class="container">
        <h1>Welcome to Mussoorie Trip form</h3>
        <p>Enter your details and submit this form to confirm your presence in the trip </p>
        <?php
        if($insert == true){
    ...
    ?>
        <form action="index.php" method="post">
            ...
            <textarea name="desc" id="desc" cols="30" rows="10" placeholder="Please,Enter any other information here"></textarea>
